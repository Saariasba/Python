...
SECRET_KEY = '&1+#zu3d@z)o=04-dko3(e_*53u447#6!^li5u&#*sw_6ufzp9'
...
INSTALLED_APPS = [
    'Foro.apps.ForoConfig', #Aplicación de Foro en Proyecto Platzi
...
DATABASES = {
    'default': {
        ...
        'NAME': 'Platzi.db', #Nombre de la Base de Datos
    }
}
...
TIME_ZONE = 'GMT' #Zona Horaria de Colombia
